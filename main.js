const RenderNotifications = async () => {
    ...
    if(notifications.length > 0) {        
        notifications.map(n => {
            ...
            div.style.background = `url('https://pobl-strapi-api.herokuapp.com${imageUrl}') no-repeat center center/cover`;
...
async function GetNotifications() {
    const response = await  fetch(`https://pobl-strapi-api.herokuapp.com/api/notifications?populate=image`)
